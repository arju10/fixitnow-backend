...
export const getSingleServiceController = catchAsync(async (req: Request, res: Response) => {
  const { id } = req.params;
...
export const getMyServicesController = catchAsync(async (req: Request, res: Response) => {
  if (!req.user) {
