...
import { createReview, getReviewsByTechnician, getMyReviews, getAverageRating, } from './reviews.service';
...
export const getTechnicianReviewsController = catchAsync(async (req, res) => {
...
export const getMyReviewsController = catchAsync(async (req, res) => {
    if (!req.user) {
        throw new ApiError(401, 'User not authenticated');
    }
