...
export const getServicesByTechnicianId = async (technicianId) => {
    return prisma.service.findMany({
        where: { technicianId },
        include: {
            category: {
...
export const createNewService = async (technicianId, input) => {
...
export const updateSingleService = async (serviceId, input) => {
