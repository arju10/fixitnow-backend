...
export const updateAdminProfile = async (userId, input) => {
    ...
    if (input.department !== undefined)
        profileData.department = input.department || null;
    if (input.position !== undefined)
        profileData.position = input.position || null;
    if (input.permissions !== undefined)
        profileData.permissions = input.permissions;
    if (input.isSuperAdmin !== undefined)
        profileData.isSuperAdmin = input.isSuperAdmin;
